 ...
 * Add to palette
 */
$GLOBALS['TL_DCA']['tl_settings']['palettes']['default'] .= ';{maxmind_legend},maxmind_url,maxmind_has_license,,maxmind_lastUpdate,maxmind_serverName,maxmind_nc';
...
$GLOBALS['TL_DCA']['tl_settings']['fields']['maxmind_serverName'] = array(
	'label'             => &$GLOBALS['TL_LANG']['tl_settings']['maxmind_serverName'],
	'exclude'           => true,
	'inputType'         => 'text',
	'eval'              => array
	(
